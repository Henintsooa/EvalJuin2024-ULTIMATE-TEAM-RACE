              ...
              <div class="card-body">
                ...
                <form method="GET" action="{{ route('loginEquipe') }}">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="Equipe" class="form-control" id="exampleInputEquipe1" aria-describedby="EquipeHelp" name="equipe" value="{{ old('equipe') }}">
                    <x-input-error :messages="$errors->get('Equipe')" class="mt-2 text-red-500"  />
                    @error('identifiant')
